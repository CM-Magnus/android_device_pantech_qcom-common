...
for FILE in `egrep -v '(^#|^$|^-)' ../$DEVICE/common-proprietary-files.txt`; do
...
echo "This is designed to extract files from an official CyanogenMod build"
./setup-makefiles.sh
